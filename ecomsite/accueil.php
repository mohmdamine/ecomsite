...
<header class="main-header">
  <div class="header-left">
    <a href="accueil.php" class="logo">📱 Phone_Shop</a>
  </div>
...
<!-- Contenu principal -->
    ...
    <div class="container">
        <h1 class="texta">Bienvenue sur Phone_Shop</h1>
        <p class="textp">vous trouverai tous vos besoin technologiques</p>
    </div>
    ...
    <div id="aa" class="ee" data-bs-ride="carousel">
        <div class="aaa">
            <div class="aaaa">
                <img src="images/image.png" class="d-block w-100 carousel-img" alt="Promo 1">
    ...
    while ($row = $result->fetch_assoc()) {
        echo '
            <div class="card-produit">
                <img src="images/' . $row["image"] . '" alt="' . $row["nom"] . '">
                <h3>' . $row["nom"] . '</h3>
                <p>' . $row["description"] . '</p>
